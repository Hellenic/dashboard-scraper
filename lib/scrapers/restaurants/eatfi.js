    ...
    request(leppavaaraEatfiRestaurantsURL, function(error, response, body) {
      ...
      restaurantDatas.forEach(data => {
        ...
        osmo = osmo.set({
          ...
          'openingDays': ['#opening-times-weekly .entries .day-name'],
          'openingTimes': ['#opening-times-weekly .entries .day-time-data']
        });
        ...
        osmo = osmo.data(function(restaurant) {
          ...
          restaurant.openingTimes = {
            days: restaurant.openingDays,
            times: restaurant.openingTimes
          };
